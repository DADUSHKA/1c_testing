...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	//ПараметрыРегистрации.Наименование =  НСтр("ru = 'Выполнение кода по расписанию'"); 
	ПараметрыРегистрации.Информация = НСтр("ru = 'Выполнение кода по расписанию'");
	...
	Команда.Идентификатор = "ВыполнениеКодаПоРасписанию";
...
Процедура ВыполнитьКоманду(ИдентификаторКоманды, ПараметрыВыполненияКоманды) Экспорт
	...
	Если ИдентификаторКоманды = "ВыполнитьКодНаСервере" Тогда
		ВыполнитьВыгрузку();
	КонецЕсли;
...
Функция ВыполнитьВыгрузку() Экспорт
	...
	Иначе
		мЗаписьXML.ОткрытьФайл("/home/vicstor/Рабочий стол/its/Выгрузка тестовая/выгрузка.xml", "UTF-8");
	КонецЕсли;
		...
		Для каждого Тип из Объект.Тип.Типы() Цикл
			...
			Если КоличествоТипов = 1 Тогда
				...
				Если мПоследнийТипДанных <> Тип Тогда
					...
					мПоследнееЗначениеТипа = ПолучитьУИИмениТипа(ПолучитьТип2(Тип));
